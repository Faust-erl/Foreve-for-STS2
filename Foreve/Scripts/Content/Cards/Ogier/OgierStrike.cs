...
[RegisterCharacterStarterCard(typeof(Characters.Ogier.OgierCharacter), 2)]
public class OgierStrike : ModCardTemplate
{
    ...
    public OgierStrike() : base(baseCost: 1, type: CardType.Attack, rarity: CardRarity.Basic, target: TargetType.AnyEnemy, showInCardLibrary: true) { }
